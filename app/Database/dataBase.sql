...
-- Volcando estructura para tabla bluebull_sandbox.person
...
-- Volcando datos para la tabla bluebull_sandbox.person: ~0 rows (aproximadamente)
...
-- Volcando estructura para tabla bluebull_sandbox.users
...
-- Volcando datos para la tabla bluebull_sandbox.users: ~1 rows (aproximadamente)
REPLACE INTO `users` (`id`, `nickname`, `email`, `password`, `active`, `created_at`, `updated_at`) VALUES
	(1, 'Drakoz', 'ury197@hotmail.com', '?ã,¥qj', 1, '2024-07-17 21:33:41', '2024-07-18 17:46:51');
